...
if __name__ == '__main__':
	...
	Dhat   = np.concatenate((Qhat_1, Qhat_1_sq), axis=1)
	...
	for pair in reg_pairs_global:
		...
		dOpInf_red_model 	= lambda x: Ahat @ x + Fhat @ compute_Qhat_sq(x)
	...
	np.savez('data/OpInf_ROM_operators.npz', Ahat=Ahat_opt, Fhat=Fhat_opt)
